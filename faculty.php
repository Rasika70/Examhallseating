    ...
    <form class="form-horizontal" action="" method="POST">
      ...
      <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <button type="submit" class="btn btn-default btn-info" name="submit">Submit</button>
        </div>
...
//$rn=$_POST['roomno'];
//$q2="SELECT * FROM faculty WHERE ROOM_NO='$rn'";
//$q3=mysqli_query($conn,$q2);
//$roomno = mysqli_fetch_array($q3);
    echo "ROOM ALLOTED TO YOU:  " ;
//	echo $rn."<br>";

    // Handle the case where no rows were returned
   // echo "No room allotted to you.";
