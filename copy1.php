...
$a1 = isset($_POST['sr1']) ? $_POST['sr1'] : '';
$a = $a1;
$b1 = isset($_POST['sr2']) ? $_POST['sr2'] : '';
$b = $b1;
$c1 = isset($_POST['sr3']) ? $_POST['sr3'] : '';
$d = $c1;
$g1 = isset($_POST['sr4']) ? $_POST['sr4'] : '';
$e = $g1;
$n1 = isset($_POST['no1']) ? $_POST['no1'] : '';
$n2 = isset($_POST['no2']) ? $_POST['no2'] : '';
$n3 = isset($_POST['no3']) ? $_POST['no3'] : '';
$n4 = isset($_POST['no4']) ? $_POST['no4'] : '';
$tm = isset($_POST['time']) ? $_POST['time'] : '';

// Check if variables used for calculations are set and numerical before performing calculations
$er1 = (isset($a1) && isset($n1) && is_numeric($a1) && is_numeric($n1)) ? ($a1 + $n1) : 0;
$er2 = (isset($b1) && isset($n2) && is_numeric($b1) && is_numeric($n2)) ? ($b1 + $n2) : 0;
$er3 = (isset($c1) && isset($n3) && is_numeric($c1) && is_numeric($n3)) ? ($c1 + $n3) : 0;
$er4 = (isset($g1) && isset($n4) && is_numeric($g1) && is_numeric($n4)) ? ($g1 + $n4) : 0; 

// Check if 'in1' and 'in2' are set in $_POST and initialize variables
$inv1 = isset($_POST['in1']) ? $_POST['in1'] : '';
$inv2 = isset($_POST['in2']) ? $_POST['in2'] : '';

// Assuming $rn, $tm, $er1, $er2, $er3, $er4 are defined elsewhere in your code
...
// Insert data into 'student' table using loops
for ($i = $a1; $i < $er1; $i++) {
    $q12 = "INSERT INTO student VALUES ('$i', '$rn')";
...
// Create a table $rm
$q2 = "CREATE TABLE IF NOT EXISTS $rm (Rows1 int, col1 bigint, col2 bigint, col3 bigint)";
if ($conn->query($q2) === TRUE) {
    // echo "Table $rm created successfully";
} else {
...
/*$r="SELECT *FROM back ";
$result = @mysqli_query($conn,$r) or die(mysqli_error());
